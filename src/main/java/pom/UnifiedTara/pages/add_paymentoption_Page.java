...
//		System.out.println(eleindex11.getLocation().getY());
		...
		// action.press(969, 2194).release().perform().press(969,
		// 2194).release().perform();
	...
	public void AddCommonBankAccount(String CommonBankACNO, String Name) throws InterruptedException {
		...
		WebElement CommonBank = aDriver
				.findElementByXPath("//android.widget.ImageView[@content-desc=\"Bank Commonwealth\"]");

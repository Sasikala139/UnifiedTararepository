...
public class HomePage extends BasePage {
	...
	public void OTPValidation(String MobileNumber, String OTP1, String OTP2, String OTP3, String OTP4, String OTP5,
			String OTP6) throws InterruptedException {
		...
		// Assert.assertEquals(isElementDisplayed(myaccounttext),true,"FAIL:Login
		// failed");

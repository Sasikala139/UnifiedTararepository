...
public class TMConstants {
	...
	// System.getProperty("user.dir")+"\\apk\\merchant-release-uat-Rel-2.1.0.apk";
	...
	// Real Device
	public static final String RealdeviceName = "Redmi sasi";
	public static final String UDID = "9ecba005";
